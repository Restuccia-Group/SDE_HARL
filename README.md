...
```tex
@article{gian2026sdeharl,
  author  = {Gian, Toan D. and Abdi, Mohammad and Bastian, Nathaniel D. and Restuccia, Francesco},
  ...
  pages   = {21287--21295},
  month   = mar,
  doi     = {10.1609/aaai.v40i25.39274},
  url     = {https://ojs.aaai.org/index.php/AAAI/article/view/39274}
}
```
